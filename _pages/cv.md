...
Projects
======
* **[SelfReflectiveRatings](https://claude.d1ef5vsv1cb198.amplifyapp.com/)** \| React, Supabase, PostgreSQL, AWS Amplify
  * Full-stack web app for personality self-assessments (BFI-2, BESSI-20) and multiplayer peer rating games
...
Skills
======
* **Programming:** C/C++/C#, Python, Java, Kotlin, HTML/CSS, JavaScript, React, SQL, OCaml, Souffle/Datalog, LaTeX
* **Tools & Platforms:** Git, Supabase, PostgreSQL, AWS Amplify, Unity, Unreal Engine, Blender
